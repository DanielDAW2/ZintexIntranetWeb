 ...
 */
final class Version20191217152532 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE t_albara (Id_Albara INT AUTO_INCREMENT NOT NULL, Descrip_Client_Albara VARCHAR(255) DEFAULT NULL, Nom_Client_Albara VARCHAR(255) DEFAULT NULL, Direccio_Client_Albara VARCHAR(255) DEFAULT NULL, Num_Albara VARCHAR(255) DEFAULT NULL, Data_Albara DATETIME DEFAULT NULL, Data_Sortida_Albara DATETIME DEFAULT NULL, NRef_Albara VARCHAR(255) DEFAULT NULL, SRef_Albara VARCHAR(255) DEFAULT NULL, Facturable_Albara TINYINT(1) DEFAULT NULL, NumFraProforma_Albara VARCHAR(255) DEFAULT NULL, NumFactura_Albara VARCHAR(255) DEFAULT NULL, Client_Albara INT DEFAULT NULL, INDEX IDX_F8494BCB305A3645 (Client_Albara), PRIMARY KEY(Id_Albara)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE t_albara_aux (codprod_albara_id INT DEFAULT NULL, Id_Albara_Aux INT AUTO_INCREMENT NOT NULL, Num_Linia INT DEFAULT NULL, DescripProd_Albara VARCHAR(1000) DEFAULT NULL, CodParamImp_Albara INT DEFAULT NULL, DescripParamImp_Albara VARCHAR(255) DEFAULT NULL, NumUnit_Albara DOUBLE PRECISION DEFAULT NULL, PreuUnit_Albara DOUBLE PRECISION DEFAULT NULL, Preu_Albara DOUBLE PRECISION DEFAULT NULL, Num_Albara INT NOT NULL, INDEX IDX_B8F7900620FE626B (Num_Albara), INDEX IDX_B8F79006DE3F184D (codprod_albara_id), PRIMARY KEY(Id_Albara_Aux)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, dni VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D6497F8F253B (dni), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
