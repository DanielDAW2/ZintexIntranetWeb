CREATE DATABASE  IF NOT EXISTS `zintex` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `zintex`;
...
CREATE TABLE `t_activitat_client` (
  ...
  `Tipus_Client` varchar(255) DEFAULT NULL,
  `Coef_Recarrec` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
CREATE TABLE `t_albara` (
  ...
  `Descrip_Client_Albara` varchar(255) DEFAULT NULL,
  `Nom_Client_Albara` varchar(255) DEFAULT NULL,
  `Direccio_Client_Albara` varchar(255) DEFAULT NULL,
  `Num_Albara` varchar(255) DEFAULT NULL,
  `Data_Albara` datetime DEFAULT NULL,
  `Data_Sortida_Albara` datetime DEFAULT NULL,
  `NRef_Albara` varchar(255) DEFAULT NULL,
  `SRef_Albara` varchar(255) DEFAULT NULL,
  `Facturable_Albara` int(11) DEFAULT NULL,
  `NumFraProforma_Albara` varchar(255) DEFAULT NULL,
  `NumFactura_Albara` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_albara_aux` (
  ...
  `CodProd_Albara` int(11) DEFAULT NULL,
  `DescripProd_Albara` varchar(1000) DEFAULT NULL,
  `CodParamImp_Albara` int(11) DEFAULT NULL,
  `DescripParamImp_Albara` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_autor_comanda` (
  ...
  `Nom_Autor_Comanda` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_autors_presup` (
  ...
  `Cod_AutPresup` varchar(255) DEFAULT NULL,
  `Descrip_AutPresup` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_bancs` (
  ...
  `Codi_Banc` varchar(4) DEFAULT NULL,
  `Banc` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`Id_Banc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_clients` (
  ...
  `Marca_Cli` varchar(5) DEFAULT NULL,
  `Codi_Cli` varchar(50) DEFAULT NULL,
  `Codi_Cli_DREAM` varchar(255) DEFAULT NULL,
  `NIF_Cli` varchar(15) DEFAULT NULL,
  `Client` varchar(255) DEFAULT NULL,
  `Client_Com` varchar(255) DEFAULT NULL,
  `Tract_Cli` int(11) DEFAULT NULL,
  `NomFra_Cli` varchar(255) DEFAULT NULL,
  `CognomFra_Cli` varchar(255) DEFAULT NULL,
  `CarrecFra_cli` varchar(255) DEFAULT NULL,
  `DirFra_Cli` varchar(1000) DEFAULT NULL,
  `CodPFra_Cli` varchar(255) DEFAULT NULL,
  `PobFra_Cli` varchar(255) DEFAULT NULL,
  `PaisFra_Cli` int(11) DEFAULT NULL,
  `TelFra_Cli` varchar(25) DEFAULT NULL,
  `FaxFra_Cli` varchar(25) DEFAULT NULL,
  `MobFra_Cli` varchar(25) DEFAULT NULL,
  `Email_Cli` varchar(200) DEFAULT NULL,
  `EmpEnt_Cli` varchar(255) DEFAULT NULL,
  `TractEnt_Cli` int(11) DEFAULT NULL,
  `PersEnt_Cli` varchar(255) DEFAULT NULL,
  `DirEnt_Cli` varchar(1000) DEFAULT NULL,
  `CodPEnt_Cli` varchar(50) DEFAULT NULL,
  `PobEnt_Cli` varchar(255) DEFAULT NULL,
  `PaisEnt_Cli` int(11) DEFAULT NULL,
  `TelEnt_Cli` varchar(25) DEFAULT NULL,
  `FaxEnt_Cli` varchar(16) DEFAULT NULL,
  `Web_Cli` varchar(200) DEFAULT NULL,
  `Met_Pag` int(11) DEFAULT NULL,
  `Inst_Pag` int(11) DEFAULT NULL,
  `Dia_Pag` varchar(2) DEFAULT NULL,
  `Problema_Pag` tinyint(1) DEFAULT NULL,
  `TitularCC_Cli` varchar(50) DEFAULT NULL,
  `CC_Cli` varchar(20) DEFAULT NULL,
  `PersFin_Cli` varchar(50) DEFAULT NULL,
  `CarrecFin_Cli` varchar(50) DEFAULT NULL,
  `TelFin_cli` varchar(16) DEFAULT NULL,
  `EmailFin_Cli` varchar(200) DEFAULT NULL,
  `Tipus_IVA` double DEFAULT NULL,
  `Tipus_REQ` double DEFAULT NULL,
  `Observacions_Cli` varchar(1000) DEFAULT NULL,
  `ObservacionsFin_Cli` varchar(1000) DEFAULT NULL,
  `Motiu_Contacte` varchar(255) DEFAULT NULL,
  `Mailing` tinyint(1) DEFAULT NULL,
  `CAT` tinyint(1) DEFAULT NULL,
  `Client_CYCRED` varchar(50) DEFAULT NULL,
  `Classificat_CYCRED` datetime DEFAULT NULL,
  `Credit_CYCRED` int(11) DEFAULT NULL,
  `Status_CYCRED` varchar(50) DEFAULT NULL,
  `Limit_CYCRED` varchar(1000) DEFAULT NULL,
  `Baixa_CYCRED` datetime DEFAULT NULL,
  `Num_Agent_Comercial` int(11) DEFAULT NULL,
  `Num_Ultim_Presup` varchar(50) DEFAULT NULL,
  `Data_Ultim_Presup` datetime DEFAULT NULL,
  `Num_Ultim_FraProforma` varchar(50) DEFAULT NULL,
  `Data_Ultim_FraProforma` datetime DEFAULT NULL,
  `Num_Ultim_Factura` varchar(50) DEFAULT NULL,
  ...
  `Activitat_2` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id_Cli`),
...
CREATE TABLE `t_clients_mails` (
  ...
  `Nom_Persona_Mail` varchar(255) DEFAULT NULL,
  `Cognom1_Persona_Mail` varchar(255) DEFAULT NULL,
  `Cognom2_Persona_Mail` varchar(255) DEFAULT NULL,
  `MailCli_Mail` varchar(255) DEFAULT NULL,
  `Departament_Mail` varchar(255) DEFAULT NULL,
  `Extensio_Mail` varchar(255) DEFAULT NULL,
  `Telefon_Mail` varchar(255) DEFAULT NULL,
  `Mobil_Mail` varchar(255) DEFAULT NULL,
  `Carrec_Mail` varchar(255) DEFAULT NULL,
  `Tractament_Persona_Mail` int(11) DEFAULT NULL,
  PRIMARY KEY (`Id_Cli_Mail`),
  CONSTRAINT `FK_91C351031D898556` FOREIGN KEY (`Id_Cli_Mail`) REFERENCES `t_clients` (`Id_Cli`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_comanda_prov` (
  ...
  `Ref_Comanda_Prov` varchar(255) DEFAULT NULL,
  `Num_Proveidor_Comanda` int(11) DEFAULT NULL,
  `Descrip_Comanda` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_comanda_prov_aux` (
  ...
  `Descrip_Prod_Prov` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_comercials` (
  ...
  `Codi_Comercial` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_comunitats_autonomes` (
  ...
  `Comunitat` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_empreses_path` (
  ...
  `Num_Any` varchar(50) DEFAULT NULL,
  `Carpeta_Pressupost` varchar(200) DEFAULT NULL,
  `Carpeta_Proforma` varchar(200) DEFAULT NULL,
  `Carpeta_Factura` varchar(200) DEFAULT NULL,
...
CREATE TABLE `t_factura` (
  ...
  `nref` varchar(40) DEFAULT NULL,
  `SRef` varchar(255) DEFAULT NULL,
  `ref_proforma` varchar(40) DEFAULT NULL,
  `Ref_Albara` varchar(255) DEFAULT NULL,
  `Ref_Presup` varchar(255) DEFAULT NULL,
  ...
  `MetPag_Aux` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_factura_aux` (
  ...
  `DescripProd_Factura` varchar(1000) DEFAULT NULL,
  `CodParamImp_Factura` int(11) DEFAULT NULL,
  `DescripParamImp_Factura` varchar(255) DEFAULT NULL,
  ...
  `Codi_Factura` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_factura_prov` (
  ...
  `Num_FraProv` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_factura_prov_vto` (
  ...
  `Concepte_FraProv_Vto` varchar(200) DEFAULT NULL,
  `InstPag_FraProv_Vto` int(11) DEFAULT NULL,
  `InstPag_Aux_FraProv_Vto` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_factura_vto` (
  ...
  `Concepte_Vto` varchar(200) DEFAULT NULL,
  `InstPag` int(11) DEFAULT NULL,
  `InstPag_Aux` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `t_fitxers_tarifes` (
  ...
  `Path_Fitxer` varchar(255) DEFAULT NULL,
  `Nom_Fitxer` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_fraproforma` (
  ...
  `Persona_FraProf` varchar(50) DEFAULT NULL,
  `Data_FraProf` datetime DEFAULT NULL,
  `Num_FraProf` varchar(255) DEFAULT NULL,
  `Ref_Presup` varchar(255) DEFAULT NULL,
  `Ref_Albara` varchar(255) DEFAULT NULL,
  `Ref_Factura` varchar(255) DEFAULT NULL,
  `NRef` varchar(255) DEFAULT NULL,
  `SRef` varchar(255) DEFAULT NULL,
  ...
  `Import_Pagat` double DEFAULT NULL,
  `Metode_Pag` int(11) DEFAULT NULL,
  `MetPag_Aux` varchar(1000) DEFAULT NULL,
  `Observ_FraProf` varchar(1200) DEFAULT NULL,
  `Seguiment` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `t_fraproforma_aux` (
  ...
  `DescripProd_Proforma` varchar(1000) DEFAULT NULL,
  `CodParamImp_Proforma` int(11) DEFAULT NULL,
  `DescripParamImp_Proforma` varchar(255) DEFAULT NULL,
  ...
  `Codi_FraProforma` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_fraproforma_plazos` (
  ...
  `DescripProd_FraProf_Plazo` varchar(255) DEFAULT NULL,
  `Baixa` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `t_grup_producte` (
  ...
  `Descrip_Grup_Producte` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_instrument_pag` (
  ...
  `Cod_Inst_Pag` varchar(6) DEFAULT NULL,
  `Nom_Inst_Pag` varchar(40) DEFAULT NULL,
  `Descripcio_Instrument` varchar(1000) DEFAULT NULL,
  `Baixa` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `t_instrument_pag_prov` (
  ...
  `Cod_Inst_Pag` varchar(6) DEFAULT NULL,
  `Nom_Inst_Pag` varchar(40) DEFAULT NULL,
  `Descripcio_Instrument` varchar(255) DEFAULT NULL,
  `Descripcio2_Instrument` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id_Inst_Pag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_metode_pag` (
  ...
  `Nom_Metode` varchar(20) DEFAULT NULL,
...
CREATE TABLE `t_observ_plazo_entrega` (
  ...
  `Titol_PlazoEntrega` varchar(1000) DEFAULT NULL,
  `NoUrgente_Titol` varchar(1000) DEFAULT NULL,
  `NoUrgente_Descrip` varchar(1000) DEFAULT NULL,
  `Urgente_Titol` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip1` varchar(1000) DEFAULT NULL,
  `Urgente_Recargo` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip2` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip3` varchar(1000) DEFAULT NULL,
  `PedidoSup_Titol` varchar(1000) DEFAULT NULL,
  `PedidoSup_Descrip` varchar(1000) DEFAULT NULL,
  `Valle_Recargo` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_observ_presup` (
  ...
  `Observ_Presup` varchar(2000) DEFAULT NULL,
  `Observ_Presup_Vto` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `t_observ_proforma` (
  ...
  `Observ_Proforma` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `t_ordre_treball` (
  ...
  `Num_FraProforma` int(11) DEFAULT NULL,
  `Num_SubOrdre` varchar(255) DEFAULT NULL,
  `Campanya` varchar(255) DEFAULT NULL,
  `Grup_Producte` int(11) DEFAULT NULL,
  `Descrip_Ordre_Treball` varchar(255) DEFAULT NULL,
  ...
  `Dissenyador` varchar(50) DEFAULT NULL,
  `Posta_Marxa` varchar(50) DEFAULT NULL,
  `Calandra` varchar(50) DEFAULT NULL,
  ...
  `Observacions_Disseny` varchar(255) DEFAULT NULL,
  `Observacions_Produccio` varchar(255) DEFAULT NULL,
  `Persona` varchar(50) DEFAULT NULL,
  `Resum_Unitats` varchar(255) DEFAULT NULL,
  `Resum_Productes` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_ordre_treball_aux` (
  ...
  `DescripProd_Ordre_Treball` varchar(1000) DEFAULT NULL,
  `CodParamImp_Ordre_Treball` int(11) DEFAULT NULL,
  `DescripParamImp_Ordre_Treball` varchar(1000) DEFAULT NULL,
  `NumUnit_Ordre_Treball` double DEFAULT NULL,
  `Metres` int(11) DEFAULT NULL,
  `Longitud` int(11) DEFAULT NULL,
  `Departament` varchar(50) DEFAULT NULL,
  `Baixa` tinyint(1) DEFAULT NULL,
  `Ample` varchar(4) DEFAULT NULL,
  `Cares` varchar(10) DEFAULT NULL,
  `Grup_Producte` int(11) DEFAULT NULL,
  `Codi_Ordre_Treball` varchar(255) DEFAULT NULL,
  `Codi_FraProforma` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `t_ordre_treball_dream_ribbons_ shop`
--

DROP TABLE IF EXISTS `t_ordre_treball_dream_ribbons_ shop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_ordre_treball_dream_ribbons_ shop` (
...
CREATE TABLE `t_paisos` (
  ...
  `Preftel_Pais` varchar(4) DEFAULT NULL,
  PRIMARY KEY (`Id_Pais`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_paramimp` (
  ...
  `Codi_ParamImp` varchar(50) DEFAULT NULL,
  `Nom_ParamImp` varchar(50) DEFAULT NULL,
  `Nom_ParamImp_Cat` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_personal` (
  ...
  `CtaCte` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_presup` (
  ...
  `Num_Presup` varchar(50) DEFAULT NULL,
  `Client_Presup` int(11) NOT NULL,
  `Marca_Cli` varchar(255) DEFAULT NULL,
  `Persona_Presup` varchar(255) DEFAULT NULL,
  `Dades_Client_Presup` varchar(1000) DEFAULT NULL,
  `Data_Presup` datetime DEFAULT NULL,
  `Text_Data_Presup` varchar(50) DEFAULT NULL,
  `Autor_Presup` int(11) NOT NULL,
  `FraProf_Presup` varchar(50) DEFAULT NULL,
  `Fra_Presup` varchar(50) DEFAULT NULL,
  `Deneg_Presup` tinyint(1) DEFAULT NULL,
  `NRef1` varchar(150) DEFAULT NULL,
  `NRef2` varchar(150) DEFAULT NULL,
  `TerminiE_Presup` varchar(200) DEFAULT NULL,
  `MetPag_Presup` int(11) NOT NULL,
  `MetPag_Aux` varchar(200) DEFAULT NULL,
  `ObservAux_Presup` varchar(1000) DEFAULT NULL,
  `ObservVto_Presup` varchar(1000) DEFAULT NULL,
  `Titol_PlazoEntrega_Aux` varchar(1000) DEFAULT NULL,
  `NoUrgente_Titol_Aux` varchar(1000) DEFAULT NULL,
  `NoUrgente_Descrip_Aux` varchar(1000) DEFAULT NULL,
  `Urgente_Titol_Aux` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip1_Aux` varchar(1000) DEFAULT NULL,
  `Urgente_Recargo_Aux` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip2_Aux` varchar(1000) DEFAULT NULL,
  `Urgente_Descrip3_Aux` varchar(1000) DEFAULT NULL,
  `PedidoSup_Titol_Aux` varchar(1000) DEFAULT NULL,
  `PedidoSup_Descrip_Aux` varchar(1000) DEFAULT NULL,
  `Data_Alta` datetime DEFAULT NULL,
  `Hora_Alta` datetime DEFAULT NULL,
  `Seguiment` varchar(1000) DEFAULT NULL,
...
CREATE TABLE `t_presup_aux` (
  ...
  `DescripProd_Presup` varchar(1000) DEFAULT NULL,
  `CodParamImp_Presup` int(11) NOT NULL,
  `DescripParamImp_Presup` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_productes` (
  ...
  `Nom_Prod` varchar(1000) DEFAULT NULL,
  `Nom_Prod_Curt` varchar(1000) DEFAULT NULL,
  `DESCRIPOT` varchar(255) DEFAULT NULL,
  `DESCRIPAL` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_productes_prov` (
  ...
  `Codi_Producte` varchar(255) DEFAULT NULL,
  `Descrip_Producte` varchar(50) DEFAULT NULL,
...
CREATE TABLE `t_productes_tarifa` (
  ...
  `Sheet_Excel` varchar(255) DEFAULT NULL,
  `Columna_Ample` varchar(4) DEFAULT NULL,
  `Columna_Rang` varchar(4) DEFAULT NULL,
...
CREATE TABLE `t_proveidors` (
  ...
  `Codi_Prov` varchar(50) DEFAULT NULL,
  `NIF_Prov` varchar(50) DEFAULT NULL,
  `Proveidor` varchar(75) DEFAULT NULL,
  `Proveidor_Com` varchar(75) DEFAULT NULL,
  `Tract_Prov` int(11) DEFAULT NULL,
  `Nom_Prov` varchar(50) DEFAULT NULL,
  `Cognom_Prov` varchar(50) DEFAULT NULL,
  `Carrec_Prov` varchar(50) DEFAULT NULL,
  `Dir_Prov` varchar(1000) DEFAULT NULL,
  `CodP_Prov` varchar(10) DEFAULT NULL,
  `Pob_Prov` varchar(50) DEFAULT NULL,
  `Pais_Prov` int(11) DEFAULT NULL,
  `Tel_Prov` varchar(12) DEFAULT NULL,
  `Fax_Prov` varchar(12) DEFAULT NULL,
  `Mob_Prov` varchar(12) DEFAULT NULL,
  `Email_Prov` varchar(100) DEFAULT NULL,
  `Web_Prov` varchar(50) DEFAULT NULL,
  `Met_Pag` int(11) DEFAULT NULL,
  `Inst_Pag` int(11) DEFAULT NULL,
  `Dia_Pag` varchar(2) DEFAULT NULL,
  `CC_Prov` varchar(20) DEFAULT NULL,
  `Observacions_Prov` varchar(2000) DEFAULT NULL,
  `Activitat_Prov` varchar(1000) DEFAULT NULL,
  `Mailing` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `t_provincies` (
  ...
  `CodPos` varchar(2) DEFAULT NULL,
  `CodTel` varchar(3) DEFAULT NULL,
...
CREATE TABLE `t_tractaments` (
  ...
  `Tractament` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2019-12-01 14:01:46
